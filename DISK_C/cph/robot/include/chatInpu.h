...
/**************************************************
function:        extern void DeleteTab(Coordinate * current_en_position,CH* ch,EN* en,char *temp ,int * num_tab,int *ch_qhwh, unsigned int *box_save);

description:     在输入框删拼音

Input:           Coordinate * current_en_position,CH* ch,EN* en,char *temp ,int * num_tab,int *ch_qhwh, unsigned int *box_save

output:          
**************************************************************/
extern void DeleteTab(Coordinate * current_en_position,CH* ch,EN* en,char *temp ,int * num_tab,int *ch_qhwh, unsigned int *box_save);
...
output:          
**************************************************************/
extern int ShowChTab(Area show_area,Coordinate current_show_position/*现在正在码的字的左上角坐标*/, int show_size/*有48，36，28*/,int *qhwh,unsigned int *box_save);
